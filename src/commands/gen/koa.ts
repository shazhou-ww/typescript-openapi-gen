...
export default class GenKoa extends Command {
  ...
  static override description =
    'Generate Koa app (controllers + routes) from OpenAPI specification'
  ...
  public async run(): Promise<void> {
    const { args, flags } = await this.parse(GenKoa)
    ...
    try {
      ...
      const routeGenerator = new KoaRouteGenerator(
        openApiDoc,
        controllerPath,
        outputPath,
        { prettierConfig },
