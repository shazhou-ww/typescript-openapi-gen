...
import { HonoRouteGenerator } from '../../lib/route-generator/index'

export default class GenHono extends Command {
  ...
  static override description =
    'Generate Hono app (controllers + routes) from OpenAPI specification'
  ...
  public async run(): Promise<void> {
    const { args, flags } = await this.parse(GenHono)
    ...
    try {
      ...
      const routeGenerator = new HonoRouteGenerator(
        openApiDoc,
        controllerPath,
        outputPath,
        { prettierConfig },
